...
//   var fail = $(this).attr("btns");
//   var queryURL = "https://api.giphy.com/v1/gifs/search?q=" +
//   fail + "qX6Q3JmmRYZaFDobSTnJ5wS44rETsldc";


//     var failImage = $("<img>");
//     failImage.attr("src", results[i].images.fixed_height.url);
//     // Adds container into container
//     gifDiv.prepend(p); 
//     // adds image into container
//     gifDiv.prepend(failImage); 
...
// $("#btns").on("click", "input", function(event){
